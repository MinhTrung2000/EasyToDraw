...
public class Fish2 extends Shape2D {
    ...
    private SKPoint2D skinShape2_CenterP = new SKPoint2D();
    ...
    public void setPropertyFish2(SKPoint2D startPoint){
        ...
        thanCa2_CenterP.setLocation(startPointFish2, RADIUS_BODY_F2_X, 0);
        vayTT2_CenterP.setLocation(startPointFish2, DISTANCE_FIN_F2_X, 0);
        skinShape2_CenterP.setLocation(startPointFish2, DISTANCE_FIN_F2_X + RADIUS_FIN_F2_X + 5, 0);
        
        vayTren2_StartP.setLocation(startPointFish2, DISTANCE_FIN_F2_X - 3, -RADIUS_BODY_F2_Y);
        vayTren2_P2.setLocation(vayTren2_StartP, LECH_TREN_2, -TOP_FIN_HEIGHT_2);
        vayTren2_P3.setLocation(vayTren2_StartP, TOP_FIN_WIDTH_2, -TOP_FIN_HEIGHT_2);
        vayTren2_EndP.setLocation(vayTren2_StartP, TOP_FIN_WIDTH_2 - LECH_TREN_2, 0);
        
        vayDuoi2_StartP.setLocation(startPointFish2, DISTANCE_FIN_F2_X - 1, RADIUS_BODY_F2_Y);
        vayDuoi2_P2.setLocation(vayDuoi2_StartP, LECH_DUOI_2, +BOTTOM_FIN_HEIGHT_2);
        vayDuoi2_P3.setLocation(vayDuoi2_StartP, BOTTOM_FIN_WIDTH_2, BOTTOM_FIN_HEIGHT_2);
        vayDuoi2_EndP.setLocation(vayDuoi2_StartP, BOTTOM_FIN_WIDTH_2 - LECH_DUOI_2, 0);
        
        duoi2_StartP.setLocation(startPointFish2, RADIUS_BODY_F2_X * 2 - 1, 0);
        duoiTren2_EndP.setLocation(duoi2_StartP, TAIL_WIDTH_2, -TAIL_HEIGHT_2);
        duoiDuoi2_EndP.setLocation(duoi2_StartP, TAIL_WIDTH_2, TAIL_HEIGHT_2);
        
        edge_duoiTren2_CenterP.setLocation(duoiTren2_EndP, 0, 2);
        
        duoiTren2_StartP2.setLocation(duoiTren2_EndP, 0, 4);
        duoi2_EndP.setLocation(duoi2_StartP, 4, 0);
        ...
        //Paint
        bodyPosToPaint.setLocation(startPointFish2, 2, 0);
        
        //lấy start của top Fin thêm 1 vài đơn vị để dịch vào trong, tương tự với những cái còn lại
        topFinPosToPaint.setLocation(startPointFish2, DISTANCE_FIN_F2_X - 3 + 2, -RADIUS_BODY_F2_Y - 1);
        botFinPosToPaint.setLocation(startPointFish2, DISTANCE_FIN_F2_X - 1 + 2, RADIUS_BODY_F2_Y + 1);
        tailPosToPaint.setLocation(startPointFish2, RADIUS_BODY_F2_X * 2 - 1 + 2, 0);
        
        first_TopFinFP_StartP.setLocation(startPointFish2, DISTANCE_FIN_F2_X - 3 + 5, -RADIUS_BODY_F2_Y - 1);
        first_TopFinFP_EndP.setLocation(first_TopFinFP_StartP, 2, -TOP_FIN_HEIGHT_2 + 2);
        
        first_botFinFP_StartP.setLocation(startPointFish2, DISTANCE_FIN_F2_X - 1 + 3, RADIUS_BODY_F2_Y + 1);
        first_botFinFP_EndP.setLocation(first_botFinFP_StartP, 1, +BOTTOM_FIN_HEIGHT_2 - 2);
        
        first_botTailFP_StartP.setLocation(startPointFish2, RADIUS_BODY_F2_X * 2 - 1 + 6, 2);
        first_botTailFP_EndP.setLocation(first_botTailFP_StartP, 1, 3);
        second_botTailFP_StartP.setLocation(first_botTailFP_StartP, 3, 2);
        second_botTailFP_EndP.setLocation(second_botTailFP_StartP, 1, 3);
        
        first_topTailFP_StartP.setLocation(startPointFish2, RADIUS_BODY_F2_X * 2 - 1 + 6, -2);
        first_topTailFP_EndP.setLocation(first_topTailFP_StartP, 1, -3);
        second_topTailFP_StartP.setLocation(first_topTailFP_StartP, 3, -2);
        second_topTailFP_EndP.setLocation(second_topTailFP_StartP, 1, -3);
        
        
        // Set cac diem mat
        // Note: chỉ cần xét tọa độ cho điểm diemMat00
        diemMat00.setLocation(startPointFish2.getCoordX() + DISTANCE_FIN_F2_X / 2, startPointFish2.getCoordY() - 2);
        ...
        /* Vẽ các điểm ở miệng */
        diemMieng1.setLocation(startPointFish2.getCoordX() + FISH_MOUTH_ADJUSTMENT_PIXEL_1[1], startPointFish2.getCoordY() + FISH_MOUTH_ADJUSTMENT_PIXEL_1[0]);
        diemMieng2.setLocation(startPointFish2.getCoordX() + FISH_MOUTH_ADJUSTMENT_PIXEL_2[1], startPointFish2.getCoordY() + FISH_MOUTH_ADJUSTMENT_PIXEL_2[0]);
        diemMieng3.setLocation(startPointFish2.getCoordX() + FISH_MOUTH_ADJUSTMENT_PIXEL_3[1], startPointFish2.getCoordY() + FISH_MOUTH_ADJUSTMENT_PIXEL_3[0]);
    }
    public void drawFish2() {
        ...
        this.drawOutlineEllipse(SKIN_SHAPE_F2_X, SKIN_SHAPE_F2_Y, skinShape2_CenterP, true, false, true, false);
        skinShape2_CenterP.setLocation(skinShape2_CenterP.getCoordX() + 4, skinShape2_CenterP.getCoordY());
        this.drawOutlineEllipse(SKIN_SHAPE_F2_X, SKIN_SHAPE_F2_Y, skinShape2_CenterP, true, false, true, false);
        skinShape2_CenterP.setLocation(skinShape2_CenterP.getCoordX() + 4, skinShape2_CenterP.getCoordY());
        this.drawOutlineEllipse(SKIN_SHAPE_F2_X, SKIN_SHAPE_F2_Y, skinShape2_CenterP, true, false, true, false);
