...
public class Fish2 extends Shape2D {
    ...
    public void drawFish2() {
        ...
        else this.drawOutlineEllipse(RADIUS_FIN_F2_X, RADIUS_FIN_F2_Y, vayTT2_CenterP, !false, !true, !false, !true);
        ...
        if(widthDirection ==1) this.drawOutlineEllipse(2, 2, edge_duoiTren2_CenterP, false, true, false, true);
        else this.drawOutlineEllipse(2, 2, edge_duoiTren2_CenterP, !false, !true, !false, !true);
        

        drawSegment(duoiTren2_StartP2, duoi2_EndP);
        if (widthDirection ==1)
        this.drawOutlineEllipse(2, 2, edge_duoiDuoi2_CenterP, false, true, false, true);
        else this.drawOutlineEllipse(2, 2, edge_duoiDuoi2_CenterP, !false, !true, !false, !true);
